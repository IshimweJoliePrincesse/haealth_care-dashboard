...
import DetailsPanel from "./app/components/details-panel/details-panel";
import LabResults from "./app/components/lab-results/lab-results";
import DiagnosisHistory from "./app/components/diagnosis-history/diagnosis-history";
import DiagnosticList from "./app/components/diagnostic-list/diagnostic-list";
import { useEffect, useState } from "react";
import { getAllPatients } from "./app/utils/axios/api";
    ...
    return (
      <main className="w-full h-full bg-customAsh grid grid-cols-[1fr_2fr_1fr] gap-8 mt-8">
        ...
        <div className="grid grid-rows-[2fr_1fr] h-screen gap-4 -mt-5 pb-4">
          <DiagnosisHistory data={patients[3].diagnosis_history} />
